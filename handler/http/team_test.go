...
var (
	successGetTeamsJSON         = "{\"code\":200,\"data\":[{\"id\":1,\"name\":\"Manchester United\"}]}\n"
	successGetTeamJSON          = "{\"code\":200,\"data\":{\"id\":1,\"name\":\"Manchester United\"}}\n"
	...
	successCreateTeamJSON       = "{\"code\":201,\"data\":{\"id\":1,\"name\":\"Manchester United\"}}\n"
